...
const Selection = ({ setTracks, setArtists, setDisplay }) => {
    ...
    return (
        <div className="flex flex-col items-center h-full">
            <div className={`${animate ? "fadeOutUp" : "fadeInUp"} flex z-10 text-6xl h-1/2 justify-center items-center text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500`}>
